                ...
                <div className="p-5 space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="bg-green-50 border border-green-100 rounded-xl p-3">
                      ...
                      <div className="text-xl font-bold text-green-700">8.247</div>
                      <div className="text-xs text-green-500 mt-0.5">67%</div>
                    </div>
                    <div className="bg-red-50 border border-red-100 rounded-xl p-3">
                      <div className="text-xs text-red-600 font-medium mb-1">Indeferimentos</div>
                      <div className="text-xl font-bold text-red-700">4.073</div>
                      <div className="text-xs text-red-500 mt-0.5">33%</div>
                    </div>
                    <div className="bg-blue-50 border border-blue-100 rounded-xl p-3">
                      <div className="text-xs text-blue-600 font-medium mb-1">Total</div>
                      <div className="text-xl font-bold text-blue-700">12.320</div>
                      <div className="text-xs text-blue-500 mt-0.5">registros</div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    {[
                      { co: 'EUROFARMA', n: 342, s: 'Deferido', ok: true },
                      { co: 'EMS S/A', n: 298, s: 'Deferido', ok: true },
                      { co: 'MEDLEY', n: 187, s: 'Deferido', ok: false },
                    ].map((row, i) => (
